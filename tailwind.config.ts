  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "intro-fade": { "0%": { opacity: "0", transform: "scale(0.92)", filter: "blur(10px)" }, "100%": { opacity: "1", transform: "scale(1)", filter: "blur(0)" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "fade-in": "fade-in 0.8s var(--ease-elegant) both",
        "fade-in-slow": "fade-in-slow 1.6s ease-out both",
        "scale-in": "scale-in 0.7s var(--ease-elegant) both",
        float: "float 6s ease-in-out infinite",
        shimmer: "shimmer 3s ease-in-out infinite",
        "intro-fade": "intro-fade 1.4s var(--ease-elegant) both",
      },
    },
  },
